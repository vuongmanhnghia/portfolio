                ...
                <BlurIn delay={0.7}>
                  <p
                    className={cn(
                      ...
                      "cursor-default font-display sm:text-xl md:text-xl whitespace-nowrap bg-clip-text select-none"
                    )}
                  >
                    Hi, I am
                    ...
                    <TooltipTrigger asChild>
                      <h1
                        className={cn(
                          ...
                          "cursor-default text-edge-outline font-display sm:text-7xl md:text-9xl select-none"
                        )}
                      >
