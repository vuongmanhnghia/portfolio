...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "vuongmanhnghia@gmail",
    href: "mailto:vuongmanhnghia@gmail.com",
  ...
  {
    name: "GitHub",
    href: "https://github.com/vuongmanhnghia",
    content: "/nagih",
...
const TOOLS = [
  {
    ...
    icon: <SiGo size={"50px"} color={"#00ADD8"} />,
    color: "#00ADD8",
  },
  {
    name: "JavaScript",
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Nghia, a DevOps Engineer with hands-on experience in deploying & automating workflows, and 
